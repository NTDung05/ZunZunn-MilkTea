            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <div class="login-box">
                           ...
                           <th><button><a href ="TRASUA/login.htm">Đăng Nhập</a></button></th>
                    <th>        <button><a href ="TRASUA/register.htm">Đăng Ký</a></button></th>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbar-menu">
                    <ul class="nav navbar-nav ml-auto" data-in="fadeInDown" data-out="fadeOutUp">
                        <li class="nav-item "><a class="nav-link" href="TRASUA/index.htm">Trang chủ</a></li>
                        <li class="nav-item"><a class="nav-link" href="TRASUA/gallery.htm">Sản phẩm</a></li>
                        <li class="nav-item"><a class="nav-link" href="TRASUA/about.htm">Thông tin</a></li>
                        
                        
                        <li class="nav-item"><a class="nav-link" href="TRASUA/contactus.htm">Liên hệ</a></li>
                    </ul>
                </div>
                <!-- /.navbar-collapse -->
