                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <p><a class="btn hvr-hover" href="TRASUA/gallery.htm">Đặt hàng</a></p>
                        </div>
                    </div>
                </div>
            </li>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="shop-cat-box">
                        ...
                        <a class="btn hvr-hover" href="TRASUA/gallery.htm">Trà Sữa</a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="shop-cat-box">
                        <img class="img-fluid" src="images/categories_img_06.jpg" alt="" />
                        <a class="btn hvr-hover" href="TRASUA/gallery.htm">Trà </a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="shop-cat-box">
                        <img class="img-fluid" src="images/categories_img_05.jpg" alt="" />
                        <a class="btn hvr-hover" href="TRASUA/gallery.htm">Sinh tố</a>
                    </div>
                </div>
            </div>
        </div>
